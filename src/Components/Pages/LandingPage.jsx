    ...
    <>
      <section className="container-fluid row justify-content-center align-items-center text-center gap-5 m-0">
        ...
        >
          ...
          <h4>
            a to-do app that helps you finish your work instead of learning how
            to use it. ClarityTasks is the blissfully simple way to manage your
            tasks across all your devices.
          </h4>
        </motion.div>
        <div className="col-12 row justify-content-center align-items-center gap-2 m-0 z-2">
          ...
          >
            ...
            <p>
              no more endless settings, tags, or folders. Just create a task,
              set a due date, and get it done. a task manager, simplified to its
              purest form.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <p>
              We keep it simple, not dumb. Tasks automatically become Overdue if
              time runs out, so you always know what needs your immediate
              attention.
            </p>
          </motion.div>
        </div>
        <div className="col-12 row justify-content-center align-items-center gap-2 m-0 z-2">
          ...
          >
            ...
            <h4>add</h4>
            <p>
              Type your task title and description. Set a due date. That's it.
            </p>
          </motion.div>
          <motion.div
            initial={{ y: 100, opacity: 0 }}
          ...
          >
            <PiNumberCircleThreeFill />
            <h4>do</h4>
            <p>Check it off. Edit it if you need to. Feel the satisfaction.</p>
          </motion.div>
        </div>
        <motion.div
        ...
        <div className="col-12 row justify-content-center align-items-center m-0 z-2 gap-2">
          ...
          >
            ...
            <p className="m-0">A: Yes. ClariTasks is completely free to use.</p>
            <p className="m-0">
              <strong>Q: How do I access my tasks on another device?</strong>
            </p>
            <p className="m-0">
              A: Just sign up once. Then use your email and password to log in
              on any device with a web browser. Your list will be waiting for
              you.
            </p>
            <p className="m-0">
            ...
            <p className="m-0">
              A: They stay in your list with a clear "Overdue" label until you
              mark them as Done or delete them, so you never forget about them.
            </p>
          </motion.div>
        </div>
        <motion.div
